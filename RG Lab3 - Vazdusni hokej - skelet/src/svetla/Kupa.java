...
public class Kupa extends Group {

    int rounds = 360;
    int r1 = 50;
    int r2 = 25;
    int h = 50;
    public PointLight svetlo;
...
//        circle2.setTranslateZ(h );
        circle2.getTransforms().addAll(new Translate(0,-h/2,0));
        circle2.setRotationAxis(Rotate.X_AXIS);
        //circle2.setRotate(90);

        svetlo=new PointLight();
        svetlo.setTranslateY(-(h/2-1));
        ...
        getChildren().addAll(cone,circle2,svetlo);
    }
